...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/11/13 10:40:43 by dzurita           #+#    #+#              #
#    Updated: 2023/11/13 10:40:58 by dzurita          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c \
       ...
       ft_strnstr.c ft_atoi.c ft_strrchr.c ft_substr.c ft_itoa.c\
	   ft_putchar_fd.c ft_strjoin.c ft_strtrim.c ft_strmapi.c\
